        ...
        <div class="max-w-lg mx-auto sm:px-6 lg:px-8">
            ...
            <div style="background-color: #1a1f2e; border: 1px solid #2d3343; border-radius: 12px; padding: 28px 32px;">
                ...
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 28px;">
                    ...
                    <span style="color: #ffffff; font-size: 18px; font-weight: 700;">Add Category</span>
                </div>
                ...
                <form method="POST" action="{{ route('category.store') }}">
                    ...
                    <div style="display: flex; align-items: center; justify-content: flex-end; gap: 12px;">
                        <a href="{{ route('category.index') }}" 
                           style="padding: 8px 20px; border-radius: 8px; font-size: 13px; font-weight: 500; color: #d1d5db; background-color: #252b3b; border: 1px solid #363d4e; text-decoration: none; transition: background-color 0.2s;">
                            Cancel
                        </a>
                        <button type="submit" 
                                style="padding: 8px 20px; border-radius: 8px; font-size: 13px; font-weight: 600; color: #ffffff; background-color: #524be0; border: none; cursor: pointer; transition: background-color 0.2s;">
                            Save Category
                        </button>
                    </div>
                </form>
